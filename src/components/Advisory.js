                ...
                <div style={{ paddingTop: 50, paddingBottom: 20 }}>
                    <Card className={cx(styles.root, shadowStyles.root)}>
                        ...
                        <CardContent>
                            ...
                            />
                             <Button className={buttonStyles}>Call us for more advise on +234 1 280 4000</Button>
                        </CardContent>
                    </Card>
                </div>
            </FadeTransform>
                    ...
                    <Card className={cx(styles.root, shadowStyles.root)}>
                        ...
                        <CardContent>
                            <TextInfoContent
                                ...
                                heading={'ACHIEVING LIFE GOALS WITH INVESTMENTS: The Concept of Building Together'}
                                body={
