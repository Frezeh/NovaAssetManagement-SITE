        ...
        <Card>
          ...
          <Card.Body className="text-center">
            ...
            <div style={{ justifyContent: "center", flexDirection: "column", alignItems: "center", marginTop: 20, }}>
              <button className="btn btn-md btn-info" onClick={toggleModal} style={{
                width: 250,
    ...
    return (
      <div className="container" style={{ alignContent: 'center' }}>
        ...
        <Modal isOpen={showModal} toggle={toggleModal}>
          <ModalHeader toggle={toggleModal}>What Quantity are you buying today?</ModalHeader>
          <ModalBody>
            <Form onSubmit={handleComment}>
              <FormGroup>
                <Label for="comment">Price</Label> {'  '}
                <Input name="comment" placeholder="$" value={comment}
                  onChange={e => setComment(e.target.value)} />
              </FormGroup>
              <FormGroup>
                <Label for="author">Price</Label> {'  '}
                <Input name="author" placeholder="Months" value={author}
                  onChange={e => setAuthor(e.target.value)} />
              </FormGroup>
              <Button type="submit" color="primary">Purchase</Button>
            </Form>
          </ModalBody>
        </Modal>
      </div>
