        ...
        >
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>{`${item.description.substring(
                0,
                75
              )}......`}</Card.Text>
        ...
        <div>
          ...
          <div className="row" data-aos="fade-up" style={{ paddingBottom: 30 }}>
            ...
            <div className="col-md-7 pt-4">
              <h3>Services</h3>
              <p className="fst-italic">Our Services</p>
              <ul>
                <li>
                  <i className="bi bi-check"></i> Wealth Management (private,
                  retail and institutional)
                </li>
                <li>
                  <i className="bi bi-check"></i> Private Trust
                </li>
                <li>
                  <i className="bi bi-check"></i> Stockbroking
                </li>
                <li>
                  <i className="bi bi-check"></i> Comprehensive financial
                  planning
                </li>
                <li>
                  <i className="bi bi-check"></i> Stockbroking
          ...
          <div className="row" data-aos="fade-up" style={{ paddingBottom: 30 }}>
            ...
            <div className="col-md-7 pt-5 order-2 order-md-1">
              <h3>Products</h3>
              <p className="fst-italic">Our Products</p>
              <ul>
                <li>
                  <i className="bi bi-check"></i> Mutual funds
                </li>
                <li>
                  <i className="bi bi-check"></i> Money market and Fixed
                  investments
                </li>
                <li>
                  <i className="bi bi-check"></i> Structured products
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="row" data-aos="fade-up" style={{ paddingBottom: 30 }}>
            <div className="col-md-5">
              <img
                src="assets/images/features-3.svg"
                className="img-fluid"
                alt=""
              />
            </div>
            <div className="col-md-7 pt-5">
              ...
              <ul>
                <li>
                  <i className="bi bi-check"></i> Endowment fund management and
                  administration
                </li>
                <li>
                  <i className="bi bi-check"></i> Employee saving schemes
                </li>
                <li>
                  <i className="bi bi-check"></i> Asset replacement
                </li>
                <li>
                  <i className="bi bi-check"></i> Specialized investment plan
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="col-md-7 pt-5 order-2 order-md-1">
              ...
              <ul>
                <li>
                  ...
                  convenient and straight-through product and services across
  ...
  return (
    <>
      ...
      <div className="container">
        <div className="row align-items-start" style={{ paddingTop: 20 }}>
          {Ndf}
          {Nmmf}
          {Etf}
        </div>
